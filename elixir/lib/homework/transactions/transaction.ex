defmodule Homework.Transactions.Transaction do
  ...
  def changeset(transaction, attrs) do
    transaction
    |> cast(attrs, [:amount, :credit, :debit, :description, :merchant_id, :user_id, :company_id])
    |> validate_required([:amount, :credit, :debit, :description, :merchant_id, :user_id, :company_id])
  end
end
